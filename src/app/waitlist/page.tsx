          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              ...
              <div className="absolute inset-0 pointer-events-none">
                {/* Top-left bracket */}
                <div className="absolute top-0 left-0 w-3 h-3 border-l-2 border-t-2 border-dark-brown"></div>
                {/* Top-right bracket */}
                <div className="absolute top-0 right-0 w-3 h-3 border-r-2 border-t-2 border-dark-brown"></div>
                {/* Bottom-left bracket */}
                <div className="absolute bottom-0 left-0 w-3 h-3 border-l-2 border-b-2 border-dark-brown"></div>
                {/* Bottom-right bracket */}
                <div className="absolute bottom-0 right-0 w-3 h-3 border-r-2 border-b-2 border-dark-brown"></div>
              </div>
